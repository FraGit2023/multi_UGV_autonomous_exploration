...
1. Go to :
  ...
  ```
2. On __lines 56-58__, three worlds can be chosen: __custom_house.world__ , __turtlebot3_dqn_stage4.world__ or __turtlebot3_world.world__. Commenting one of the three lines, the world related to the de-commented line will start. Be sure to have always one of the two line commented.
...
👉 [Download PDF Documentation]((./docs/documentation.pdf))
